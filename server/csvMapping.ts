...
const SEAMLESS_COLUMN_MAPPING: Record<string, string[]> = {
  ...
  email: ['email', 'email address', 'work email', 'work_email', 'primary email'],
  email2: ['email 2', 'email2', 'secondary email', 'secondary_email', 'personal email'],
  email3: ['email 3', 'email3', 'tertiary email'],
  phoneNumber: ['phone', 'phone number', 'phone_number', 'mobile', 'cell phone', 'cell'],
  phoneCell: ['cell phone', 'cell', 'mobile phone', 'mobile', 'cell_phone'],
  phoneLandline: ['landline', 'office phone', 'office', 'work phone', 'phone (office)'],
