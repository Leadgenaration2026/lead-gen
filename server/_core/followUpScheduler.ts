...
function getSignatureHtml(signature: any): string {
  ...
  if (signature.signaturePlainText && signature.signaturePlainText.trim()) {
    ...
    return `<br/><br/><div style="font-family:Arial,sans-serif;font-size:15px;color:#555;border-top:1px solid #e5e7eb;padding-top:12px;margin-top:16px;">${htmlLines.join('')}</div>`;
  }
