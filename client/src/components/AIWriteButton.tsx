...
export function AIWriteButton({
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      toast.success(
        `Email generated by Claude (${result.model})! Review and edit as needed.`,
        { duration: 5000 }
      );
      setOpen(false);
      setPrompt("");
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Describe what you want to say and Claude will write a professional, concise email with bullet points and a clear call-to-action.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 text-sm text-purple-800">
              <p className="font-medium mb-1">Claude will generate:</p>
              <ul className="text-xs space-y-0.5 list-disc pl-4">
                <li>A spam-proof subject line (under 40 chars, lowercase)</li>
                <li>Plain text email body (no HTML)</li>
                <li>2-4 bullet points (•) highlighting key benefits</li>
                <li>Clear call-to-action with booking link</li>
                {includeVariables && (
                  <li className="text-purple-600 font-medium">Template variables ({"{{ownerName}}"}, {"{{companyName}}"}) for bulk sending</li>
                )}
              </ul>
            </div>
