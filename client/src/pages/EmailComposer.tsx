        ...
        <TabsContent value="single" className="mt-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              {selectedLeadData && (
                <Card className="border-blue-200 bg-blue-50/50">
                  ...
                  <CardContent className="text-sm space-y-2 text-blue-800">
                    ...
                    {(selectedLeadData as any).linkedinUrl && (
                      <div className="flex justify-between">
                        <span className="font-medium">LinkedIn:</span>
                        <a href={(selectedLeadData as any).linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 hover:underline truncate max-w-[140px]">View Profile</a>
                      </div>
                    )}
                    {(selectedLeadData as any).instagramUrl && (
                      <div className="flex justify-between">
                        <span className="font-medium">Instagram:</span>
                        <a href={(selectedLeadData as any).instagramUrl} target="_blank" rel="noopener noreferrer" className="text-xs text-pink-600 hover:underline truncate max-w-[140px]">View Profile</a>
                      </div>
                    )}
                  </CardContent>
                </Card>
              ...
              {/* Social Outreach Card */}
              {selectedLeadData && ((selectedLeadData as any).linkedinUrl || (selectedLeadData as any).instagramUrl) && (
                <Card className="border-green-200 bg-green-50/50">
                  ...
                  <CardContent className="text-sm space-y-3">
                    <p className="text-xs text-green-700">Reach out to this lead on social media in addition to email.</p>
                    {(selectedLeadData as any).linkedinUrl && (
                      <a
                        href={(selectedLeadData as any).linkedinUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 rounded-md bg-blue-600 text-white text-xs font-medium hover:bg-blue-700 transition-colors w-full justify-center"
                      >
                    ...
                    {(selectedLeadData as any).instagramUrl && (
                      <a
                        href={(selectedLeadData as any).instagramUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 rounded-md bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-medium hover:from-purple-700 hover:to-pink-700 transition-colors w-full justify-center"
                      >
                    ...
                    <p className="text-[10px] text-green-600 mt-2">Tip: Multi-channel outreach (email + social) increases response rates by 3x</p>
                  </CardContent>
                </Card>
              )}
            </div>
